...
(() => {
    ...
    class Project {
        ...
        constructor(initialData) {
            ...
            data.labels = [];
			 data.catalogue_files = [];
            data.labelschema_files = [];
			...
			if (Array.isArray(initialData.catalogue_files)) {
                data.catalogue_files = [...initialData.catalogue_files];
            }

            if (Array.isArray(initialData.labelschema_files)) {
                data.labelschema_files = [...initialData.labelschema_files];
            }
            ...
            Object.defineProperties(
                ...
                Object.freeze({
                    ...
                    labels: {
					 ...
					 catalogue_files: {
                        get: () => [...data.catalogue_files],
                        set: (catalogue_files) => {
                            if (!Array.isArray(catalogue_files)) {
                                throw new ArgumentError('Value must be an array of Labels');
                            }

                            data.catalogue_files = [...catalogue_files];
                        },
                    },

                    labelschema_files: {
                        get: () => [...data.labelschema_files],
                        set: (labelschema_files) => {
                            if (!Array.isArray(labelschema_files)) {
                                throw new ArgumentError('Value must be an array of Labels');
                            }

                            data.labelschema_files = [...labelschema_files];
                        },
                    },
