...
export enum SettingsActionTypes {
    ...
    CHANGE_SHAPES_BRIGHTNESS = 'CHANGE_SHAPES_BRIGHTNESS',
    CHANGE_SHAPES_CONTRAST = 'CHANGE_SHAPES_CONTRAST',
    CHANGE_SHAPES_SATURATION = 'CHANGE_SHAPES_SATURATION',
...
export function changeBrightness(brightness: number): AnyAction {
    return {
        type: SettingsActionTypes.CHANGE_SHAPES_BRIGHTNESS,
        payload: {
            brightness,
        },
    };
...
export function changeContrast(contrast: number): AnyAction {
    return {
        type: SettingsActionTypes.CHANGE_SHAPES_CONTRAST,
        payload: {
            contrast,
        },
    };
...
export function changeSaturation(saturation: number): AnyAction {
    return {
        type: SettingsActionTypes.CHANGE_SHAPES_SATURATION,
        payload: {
            saturation,
        },
    };
